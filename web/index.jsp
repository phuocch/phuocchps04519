  ...
  <div id="main_content">
     ...
     <c:forEach var="rows" items="${listSP}">
      <div class="prod_box">
        ...
        <div class="center_prod_box">
          ...
          <div class="prod_price"><span class="reducec">${rows.price}</span> <span class="price">vnd</span></div>
        </div>
    ...
    <div class="right_content">
      <div class="shopping_cart">
        ...
        <div class="cart_icon"><a href="index_1.jsp" title="header=[Checkout] body=[&nbsp;] fade=[on]"></a></div>
      </div>
