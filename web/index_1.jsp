  ...
  <div id="main_content">
     ...
     <c:forEach var="rows" items="${list}">
      <div class="prod_box">
        ...
        <div class="center_prod_box">
          <div class="product_title"><a href="#">${rows.name}</a></div>
          <div class="product_img"><a href="#"><img src="${rows.image}" alt="" border="0" width="80px" height="80px"/></a></div>
    ...
    <div class="right_content">
      <div class="shopping_cart">
        ...
        <div class="cart_icon"><a href="#" title="header=[Checkout] body=[&nbsp;] fade=[on]"></a></div>
      </div>
