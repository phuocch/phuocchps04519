...
<div id="main_container">
  <div class="top_bar">
    ...
    <div class="languages">
      ...
      <a href="#" class="lang"><img src="templet/WS/images/en.gif" alt="" border="0" /></a> <a href="#" class="lang"><img src="images/de.gif" alt="" border="0" /></a> </div>
  </div>
  <div id="header">
  ...
  <div id="main_content">
    <div id="menu_tab">
      ...
      <ul class="menu">
          <li><a href="index_1.jsp" class="nav1"> Home</a></li>
        <li class="divider"></li>
        <li><a href="index_1.jsp" class="nav2">Products</a></li>
        <li class="divider"></li>
        <li><a href="index_1.jsp" class="nav3">Specials</a></li>
        <li class="divider"></li>
    ...
    <div class="left_content">
      ...
      <div class="border_box">
        ...
        <div class="product_img"><a href="#"><img src="templet/WS/images/laptop.png" alt="" border="0" /></a></div>
    ...
    <div class="right_content">
      <div class="shopping_cart">
        ...
        <div class="cart_icon"><a href="#" title="header=[Checkout] body=[&nbsp;] fade=[on]"><img src="templet/WS/images/shoppingcart.png" alt="" width="48" height="48" border="0" /></a></div>
      </div>
      <div class="title_box">What?s new</div>
      <div class="border_box">
        <div class="product_title">Motorola 156 MX-VL</div>
        <div class="product_img"><a href="#"><img src="templet/WS/images/p2.gif" alt="" border="0" /></a></div>
        <div class="prod_price"><span class="reduce">350$</span> <span class="price">270$</span></div>
      </div>
