...
<div id="main_container">
  <div class="top_bar">
    <div class="top_search">
      ...
      <input type="image" src="templet/WS/images/search.gif" class="search_bt" name="action" value="Search" />
        </form>
    </div>
    <div class="languages">
      <div class="lang_text">Languages:</div>
      <a href="#" class="lang"><img src="templet/WS/images/en.gif" alt="" border="0" /></a> <a href="#" class="lang"><img src="templet/WS/images/de.gif" alt="" border="0" /></a> </div>
  </div>
  <div id="header">
  ...
  <div id="main_content">
     ...
     <c:forEach var="rows" items="${listSP}">
      <div class="prod_box">
        ...
        <div class="center_prod_box">
          <div class="product_title"><a href="details.html">${rows.name}</a></div>
          <div class="product_img"><a href="details.html"><img src="${rows.image}" alt="" border="0" width="80px" height="80px"/></a></div>
          <div class="prod_price"><span class="reduce">${rows.price}</span> <span class="price">270$</span></div>
        </div>
        <div class="bottom_prod_box"></div>
        <div class="prod_details_tab"> <a href="#" title="header=[Add to cart] body=[&nbsp;] fade=[on]"><img src="templet/WS/images/cart.gif" alt="" border="0" class="left_bt" /></a> <a href="#" title="header=[Specials] body=[&nbsp;] fade=[on]"><img src="images/favs.gif" alt="" border="0" class="left_bt" /></a> <a href="#" title="header=[Gifts] body=[&nbsp;] fade=[on]"><img src="images/favorites.gif" alt="" border="0" class="left_bt" /></a> <a href="details.html" class="prod_details">details</a> </div>
      </div>
      </c:forEach>
    ...
    <div class="right_content">
      <div class="shopping_cart">
        <div class="cart_title">Shopping cart: welcom,</div>
